...
**🔤 컬럼명 대소문자 규칙
- 카멜케이스 컬럼명은 반드시 쌍따옴표로 감싸기: "createdAt", "updatedAt", "userId"
- PostgreSQL은 대소문자를 구분하므로 정확한 케이스 사용 필요
- 소문자 컬럼명은 따옴표 없이 사용 가능: created_at, user_id
- 혼용 예시: SELECT "userId", created_at, "updatedAt" FROM users;`;
